(function (global, factory) {
	...
	function ChildReconciler(shouldTrackEffects) {
	    ...
	    function reconcileChildrenArray(returnFiber, currentFirstChild, newChild) {
	        ...
	        while (current !== null) {
	            console.log(`🚀 ~ file: childFibers.ts:142 ~ current:`, current);
	        ...
	        for (let index = 0; index < newChild.length; index++) {
	            ...
	            console.log(`🚀 ~ file: childFibers.ts:151 ~ after:`, after);
	            const newFiber = updateFromMap(returnFiber, existingChildren, index, after);
	            console.log(`🚀 ~ file: childFibers.ts:158 ~ newFiber:`, newFiber);
	            if (newFiber === null) {
	                continue;
	            }
	            //  3. 标记移动还是插入
	        ...
	        console.log(`🚀 ~ file: childFibers.ts:202 ~ firstNewFiber:`, firstNewFiber);
	    ...
	    return function reconcileChildFibers(returnFiber, currentFiber, newChild) {
	        ...
	        if (typeof newChild === 'object' && newChild !== null) {
	            ...
	            if (Array.isArray(newChild)) {
	                console.log(`🚀 ~ file: childFibers.ts:268 ~ newChild:`, newChild);
	        ...
	        console.log(`🚀 ~ file: childFibers.ts:289 ~ currentFiber:`, currentFiber);
	        // 兜底删除
	...
	function reconcileChildren(wip, children) {
	    ...
	    if (current !== null) {
	        ...
	        const m = mountChildFibers(wip, null, children);
	        console.log(`🚀 ~ file: beginWork.ts:82 ~ m:`, m);
	        // mount
	        wip.child = m;
	    }
	...
	function performUnitOfWork(fiber) {
	    ...
	    console.log(`🚀 ~ file: workLoop.ts:79 ~ next:`, next);
	    // 结束之后
	...
	function completeUnitOfWork(fiber) {
	    let node = fiber;
	    console.log(`🚀 ~ file: workLoop.ts:91 ~ node:`, node);
	    do {
	        completeWork(node);
